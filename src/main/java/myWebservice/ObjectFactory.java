...
public class ObjectFactory {
    ...
    private final static QName _FindScore_QNAME = new QName("http://chapter41/", "findScore");
    private final static QName _FindScoreResponse_QNAME = new QName("http://chapter41/", "findScoreResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter41/", name = "findScore")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter41/", name = "findScoreResponse")
