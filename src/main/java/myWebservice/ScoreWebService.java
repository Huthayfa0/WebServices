 ...
 * 
 */
@WebServiceClient(name = "ScoreWebService", targetNamespace = "http://chapter41/", wsdlLocation = "http://localhost:8080/WebServices-1.0-SNAPSHOT/ScoreWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SCOREWEBSERVICE_QNAME = new QName("http://chapter41/", "ScoreWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServices-1.0-SNAPSHOT/ScoreWebService?wsdl");
    ...
    public ScoreService getScoreServicePort() {
        return super.getPort(new QName("http://chapter41/", "ScoreServicePort"), ScoreService.class);
    }
    ...
    public ScoreService getScoreServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://chapter41/", "ScoreServicePort"), ScoreService.class, features);
    }
